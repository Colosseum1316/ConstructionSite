...
internal class TestMapCurrentlyLiveCommand {
    companion object {
    ...
    fun test() {
        ...
        val labelSetLive: String = command.aliases[1]

        Assertions.assertTrue(teleportManager.teleportPlayer(player1, Location(worldMap, 0.0, 0.0, 0.0)))
        Assertions.assertTrue(command.runConstruction(player1, labelIsLive, arrayOf()))
        ...
        Assertions.assertTrue(command.runConstruction(player1, labelSetLive, arrayOf()))
