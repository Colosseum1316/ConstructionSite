...
class TestWorldUtils {
    ...
    void testPreservedLevelName() {
        ...
        Assertions.assertTrue(WorldUtils.isLevelNamePreserved(MapConstants.WORLD));
        Assertions.assertTrue(WorldUtils.isLevelNamePreserved(MapConstants.WORLD_LOBBY));
